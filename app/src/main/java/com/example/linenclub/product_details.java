...
public class product_details extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lv = (ListView)findViewById(R.id.listview_dtl);
        SharedPreferences sh = PreferenceManager.getDefaultSharedPreferences(getApplicationContext());
        String hu = sh.getString("ip", "");
        String url = "http://" + hu + ":8000/myapp/android_view_products_details/";
...
//                                listView1.setAdapter(ad);
                                lv.setAdapter(new custome_product_details(getApplicationContext(), product,quantity,size,material,length));
//
                            }
